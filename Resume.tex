...
\begin{itemize}[noitemsep,topsep=2pt]
    ...
    % \item \textbf{Core Competencies:} Research and Analysis, Technical Writing, Problem Solving, Data Analysis
    % \item \textbf{Soft Skills:} Team Leadership, Cross-functional Collaboration, Mentoring, Communication Skills.
\end{itemize}
